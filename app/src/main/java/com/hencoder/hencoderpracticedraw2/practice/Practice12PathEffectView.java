...
public class Practice12PathEffectView extends View {
    ...
    PathEffect pathEffect2 = new DiscretePathEffect(5, 2);
    PathEffect pathEffect3 = new DashPathEffect(new float[]{10f, 3f, 20f, 5f}, 0);
    Path path2 = new Path();
    ...
    PathEffect pathEffect4 = new PathDashPathEffect(path2, 10, 0, PathDashPathEffect.Style.MORPH);
